...
import type { CatalogItem, GrupoValorFijoCreateUpdateDto } from '../types/configuration'
...
const emit = defineEmits<{
  (e: 'save', dto: GrupoValorFijoCreateUpdateDto): void
}>()
...
<template>
  ...
  >
    <div class="flex flex-column gap-4 pt-2">
      ...
      <div class="field">
        <label class="field-label">Tipos de valor fijo</label>
        <MultiSelect
          v-model="tiposIds"
          :options="tipos"
